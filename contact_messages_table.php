...
?>
<center>
  <h1 style="color: darkblue; font-family: tahoma; font-weight: bold; font-size: 40px;">Client Message Table</h1>
  <table border="1" cellspacing="0" cellpadding="10" >
    ...
    <tr bgcolor="white" style="border-color: orange; border: 1px">
      ...
      <td><?php echo $rows['date_of_message']; ?> </td>
    </tr>
    <?php
      }
    }
