...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO mentees_info (first_name, last_name, phone, age, gender, profile_photo_file, national_id_file, education_level, field_of_interest, location, bio)
            VALUES ('$first_name', '$last_name', '$phone', '$age', '$gender','$profile_photo_file','$national_id_file', '$education_level', '$field_of_interest', '$location', '$bio')";
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        include"mentees_sign_in&up.html";
    } else {
