...
$sql = "SELECT * FROM mentees_info";
$result = mysqli_query($con, $sql);
include 'header.php';
?>
<center>
  <h1 style="color: darkblue; font-family: tahoma; font-weight: bold; font-size: 40px;">Mentees Information Table</h1>
  <table border="1" cellspacing="0" cellpadding="10" >
    ...
    <tr bgcolor="white" style="border-color: orange; border: 1px">
      <td><?php echo $rows['mentee_info_id']; ?> </td>
