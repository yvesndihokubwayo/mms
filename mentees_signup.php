...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO mentees (name, email, password)  VALUES ('$name', '$email', '$password')";
    
    // Execute the insert statement
    if (mysqli_query($conn, $sql)) {
        echo "<h3 style='color: darkblue; font-family: emailncy fb; font-weight: bold; padding-left: 5%'; text-align: center>
        Your account was successfully created!<br> Now fill the form below and enroll at MM^S a mentee</h3>";
        include "mentees_reg.html";
